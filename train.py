...
import time
import math
from models.faceboxes_2q import Face
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 1 == 0 and epoch > 0) or (epoch % 1 == 0 and epoch > 200):
                torch.save(net.state_dict(), args.save_folder + 'v2_epoch_' + repr(epoch) + '.pth')
            epoch += 1
    ...
    torch.save(net.state_dict(), args.save_folder + 'Final_v2.pth')
